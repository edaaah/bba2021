    ...
    <div id="wrap">
        ...
        <div id="container">
            <div class="container_in">
                <form class="content" action="modify" method="post">
                    <div class="con_left">
                        <div class="input_content">
                            <select name="boardName" id="">
                                <option value="" >게시판 선택</option>
                                <option value="notice" <c:out value="${modify.boardName=='notice'?'selected':''}" />>공지사항</option>
                                <option value="qna" <c:out value="${modify.boardName=='qna'?'selected':''}" />>Q&A</option>
                            </select>
                            <div class="input_tw">
                            	<input type="hidden" value="${modify.bno}" name="bno">
                                <input type="text" placeholder="제목" value="${modify.title}" name="title">
                                <p>${modify.writer}</p>
                            </div>
                            <p><textarea name="content" id="" cols="150" rows="30">${modify.content}</textarea></p>
                        </div>
                    </div>
                    <div class="con_right">
                        <input type="submit" value="수정하기">
                        <input type="button" value="삭제하기" onclick="location.href='/board/remove?bno=${modify.bno}'">
                    </div>
                </form>
            </div>
        </div>
