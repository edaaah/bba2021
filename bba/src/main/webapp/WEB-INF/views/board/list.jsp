            ...
            <div id="headerIn">
                ...
                <div class="h_util">
                    <div>
                        ...
                        <p><a href="http://localhost:8080/board/notice_list">board</a></p>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="content">
                    <div class="con_left" id="work">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="list">
                                        ...
                                        <p class="title"><c:out value="${boardList.title}"></c:out></p>
                                        <p class="writer"><c:out value="${boardList.writer}"></c:out></p>
                                        <p class="date"><fmt:formatDate value="${boardList.regDate}" pattern="yyyy/MM/dd"/></p>
                                    </div>
                                    <p class="text"><c:out value="${boardList.content}"></c:out></p>
                                </li>
                                </c:forEach>
                            </ul>
                        </div>
                        ...
                        <div class="item_pager">
                            ...
                            <p><a href="/board/list?pageNum=${pageMaker.startPage - 1}&amount=${pageMaker.cri.amount}">＜</a></p>
                            </c:if>
                            <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                            <p><a href="/board/list?pageNum=${num}&amount=${pageMaker.cri.amount}">${num}</a></p>
                            </c:forEach>
                            <c:if test="${pageMaker.next}">
                            <p><a href="/board/list?pageNum=${pageMaker.endPage + 1}&amount=${pageMaker.cri.amount}">＞</a></p>
                            </c:if>
                        </div>
                    </div>
                    <div class="con_right">
