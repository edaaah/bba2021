            ...
            <div class="container_in">
                <div class="content">
                    <div class="con_left" id="work">
                        <div class="con_top">
                            <ul class="tabs_nav">
                                <li><a href="http://localhost:8080/board/notice_list?boardName=notice" class="nav_notice">공지사항</a></li>
                                <li><a href="http://localhost:8080/board/qna_list?boardName=qna">Q&A</a></li>
                            </ul>
                            <button type="button"><a href="http://localhost:8080/board/register">글쓰기</a></button>
                        </div>
                        <div class="notice tabs_panel" id="b_notice">
                            <div class="b_top">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="list">
                                    	<input type="hidden" value="${boardList.bno}" id="bno">
                                    ...
                                    <p class="text" title="클릭시 수정 및 삭제가 가능합니다."><a href="http://localhost:8080/board/modify?bno=${boardList.bno}">${boardList.content}</a></p>
                                </li>
                                </c:forEach>
                            </ul>
                        </div>
                        <div class="item_pager">
                            ...
                            <p><a href="/board/notice_list?type=${pageMaker.cri.type}&pageNum=${pageMaker.startPage - 1}&amount=${pageMaker.cri.amount}&boardName=notice&keyword=${pageMaker.cri.keyword}">＜</a></p>
                            </c:if>
                            <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                            <p><a href="/board/notice_list?type=${pageMaker.cri.type}&pageNum=${num}&amount=${pageMaker.cri.amount}&boardName=notice&keyword=${pageMaker.cri.keyword}">${num}</a></p>
                            </c:forEach>
                            <c:if test="${pageMaker.next}">
                            <p><a href="/board/notice_list?type=${pageMaker.cri.type}&pageNum=${pageMaker.endPage + 1}&amount=${pageMaker.cri.amount}&boardName=notice&keyword=${pageMaker.cri.keyword}">＞</a></p>
                            </c:if>
                        </div>
                    </div>
                    <div class="con_right">
                        <form id="searchForm" action="/board/notice_list" method="get">
                            <select name="type" id="">
                            ...
                            <div class="search_box">
	                            ...
	                            <p><input type="hidden" name="boardName" value="${pageMaker.cri.boardName}"></p>
